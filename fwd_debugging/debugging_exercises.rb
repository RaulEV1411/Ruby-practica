...
def decrement_smallest_value(nested_array)
  ...
  nested_array = [[1,2,3],[2,3,4],[3,4,5]]

  p decrement_smallest_value(nested_array)
  ...
  p increment_greatest_value(nested_array)
...
# Una vez que encuentre el error, arreglelo y haga que el test pase
  ...
  def yell_greeting(string)
    name = string
    name = name.downcase
    greeting = "WHATSSAP, #{name}!"
  end

  p yell_greeting("RAUL")